...
public class RectElementHandler extends ElementHandler {
     ...
     * 
     * % To draw a rectangle:
     * > q                   % Save the graphics state (I might not do this if
     * >                     % everything's explicit)
     * > r g b rg            % Set the fill color
     * > r g b RG            % Set the stroke color if applicable
     * > x y width height re % Actually add the rectangle
     * > b                   % Or "B n" (Depends on if there's a stroke color)
     * > Q                   % Restore the graphics state (Only if I'm doing q)
     * 
     * Relevant SVG variables:
     * - stroke (either a color or none)
     * - fill (either a color or none)
     * - stroke-width
     * - width
     * - height
     * - x
